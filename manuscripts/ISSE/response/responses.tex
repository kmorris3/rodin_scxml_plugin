...
\begin{response}
\InlineComment{Son: Please change in the manuscript}
  \begin{quote}
    `` ...
   ''
  \end{quote}
...
\begin{response}
\InlineComment{Son: Add some comments of the complexity of the models and and translating them to TLA}
\InlineComments{Son: Add to manuscript in the related work section TLA}
  \begin{quote}
    `` ...
   ''
  \end{quote}
...
\begin{response}
\InlineComments{Son: Rephrace in page 23 second bullet point the fact that the variant is model specific. Add a couple of sentences on the semantic nature of the other variants}
  \begin{quote}
    `` ...
   ''
  \end{quote}
...
\begin{response}
\InlineComment{Add references to previous case studies. Make a case that the case studies have grown in complexity and the thje drone in particular makes use of all the features for model construction and refinement. SecBot and Turnstile}
  \begin{quote}
    `` ...
   ''
  \end{quote}
...
\begin{response}
\InlineComment{Karla: Add section 3.2 for refinement rules}
  \begin{quote}
    `` ...
   ''
  \end{quote}
