...
Hence, all of the safety properties that we consider are captured as invariants of the form: |S=TRUE ⇒ P|, where the antecedent is implicit from the containment of |P| within |S|.
