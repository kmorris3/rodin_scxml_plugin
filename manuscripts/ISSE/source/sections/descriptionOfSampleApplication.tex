...
The initial abstraction and first refinement of the model, shown in Figure~\ref{fig:drone1}, captures the basic functionality of the drone. 
...
\ColinInlineComment{Fig 2 actually shows two levels - drone 0 and drone 1. I have corrected the text, could you change the colours of the substates}
% \begin{figure}[!h]
\begin{figure}[]
	\vspace{-.4cm}
	\centering
...
% \end{figure} 
% \begin{figure}[!h]
\ColinInlineComment{Fig 3 guards are incorrect.. 2 transitions to OPERATIONAL s.b. charge>50, transition to FLY s.b. change >40}
\begin{figure}[]
	\centering
...
Figure~\ref{fig:drone4} builds on Figure~\ref{fig:drone4} to show three more refinements to the drone model. 
