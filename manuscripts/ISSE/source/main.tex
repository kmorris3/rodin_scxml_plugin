...
\title{Formal verification of run-to-completion style statecharts using Event-B}
...
\maketitle
\KarlaInlineComment{ Do we want to change the tile to: Formal verification and validation of run-to-completion style statecharts using Event-B }
