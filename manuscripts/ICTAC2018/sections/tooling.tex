...
The following syntax extensions are added to \SCXML models to support modelling features needed in \iUMLB/\EventB. These extensions are prefixed with `iumlb:' in order to distinguish them for the \SCXML XML parser. (So that they are ignored by \SCXML simulation tools). 
