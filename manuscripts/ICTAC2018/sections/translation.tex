...
\ColinCommented{Suggestion: - SEE EXAMPLE AT END OF THIS SECTION - we could simplify listings by ommitting labels and some attributes s.a. 'not theorem', 'ordinary' and 'extended' (for latter, make sure any features that are from the abstract version are copied down ) }
