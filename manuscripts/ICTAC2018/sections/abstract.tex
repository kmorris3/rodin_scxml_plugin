...
\Statechart modelling notations
...
\SonCommented{I changed State-chart to Statechart for consistency with Harel's paper. Commands are created for convenience}
\keywords SCXML, \Statecharts, \EventB, iUML-B, refinement
\end{abstract}
