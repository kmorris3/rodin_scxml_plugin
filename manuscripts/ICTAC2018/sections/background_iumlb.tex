...
%A choice of two alternative translation encodings are supported by the iUML-B tools.  
...
%
\footnote{%
  Here, $\mathrm{partition(S, T1, T2, \ldots)}$ means the set $S$ is partitioned into (sub-)sets $T1, T2, \ldots$.
} %
