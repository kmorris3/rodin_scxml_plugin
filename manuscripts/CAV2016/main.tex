...
An example statechart model is shown in Figure  \ref{fig:StatemachineSCXML}, and a section of the SCXML syntax is shown in Figure \ref{fig:scxml}. We use this example to illustrate points throughout the paper.

\begin{figure*}
\centering
\begin{minipage}[b]{.45\textwidth}
  \includegraphics[width=1.2\textwidth]{caseStudy/TurnstileSimpleModel}
  \label{fig:StatemachineSCXML}
\caption{SCXML Statechart diagram}\label{label-a}
\end{minipage}\qquad
\begin{minipage}[b]{.45\textwidth}
  \includegraphics[width=1.2\textwidth]{caseStudy/TurnstileSimpleModel_iumlb}
  \label{fig:StatemachineiUML-B}
\caption{State-machine diagram in iUML-B at refinement level 3 (partially annotated with guards and actions)}\label{label-b}
\end{minipage}
% \caption{ and }
\end{figure*}
