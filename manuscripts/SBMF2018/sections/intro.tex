...
\ColinAdded{At that stage we suggested the necessary extensions and basic mechanism of translation but had not solved the more challenging problem of refinement with run to completion semantics.} 
