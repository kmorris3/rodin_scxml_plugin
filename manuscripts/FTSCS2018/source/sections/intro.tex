...
The binding is facilitated by translating to \iUMLB~\cite{snook14:_b_statem,Snook2006,Snook12:FMCO}, a diagrammatic modelling notation for \EventB, that has an existing binding to Event-B.
...
% \Rodin provides support for \EventB including automatic theorem provers.  
% \iUMLB augments the \EventB language with a graphical interface including
% state-machines.  
