...
\begin{response}
  We have rewritten the paragraph using simple bullet points.
  \KarlaInlineComment{The above is not true}
\end{response}
...
\begin{response}
  We tried the best we can, however without further details, it is difficult to see what can be improved. Moreover, other reviewers think it is already easy to follow.
\end{response}
