...
To cater for this we express |P| in a modified form |P'| that allows time for the reaction to take place. \todo{COLIN: P is check in stable states that are reachable according to the run-to-completion}
