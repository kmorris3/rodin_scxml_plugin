...
\todo{COLIN: Revised sentence to capture the following, verification that a model satisfy some invariant e.g safetly property does not guarantee that the model behaves in a useful way}
...
\end{center}
\CTchange{This property can be copied and pasted into the ProB model checker LTL checking text field.}{This property can be added into the ProB model checker LTL formula text field.}
