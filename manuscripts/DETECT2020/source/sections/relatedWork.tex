...
\begin{enumerate}
\item  \emph{Rule A:} Guard conditions on a transition can be strengthened; 
...
example is developed. \todo{Son Remove reference to example} For example, the transition triggered by |toLand| 
...
considered less suited to development of safety-critical systems.\todo{Revised the abstraction discussion in the introduction}
