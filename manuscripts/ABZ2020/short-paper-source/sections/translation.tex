...
\todo{Remove the translation section and put some high level summary of the traslation inot the run2completion section}
...
\item[Trigger queues in basis:]
  \begin{sloppypar}
    ...
    % and was found to be necessary in order to model the new drone case study properly.
  \end{sloppypar}
