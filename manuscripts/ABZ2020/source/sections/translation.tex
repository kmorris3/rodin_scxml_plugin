...
\begin{itemize}
	\item 
Firstly, a basis machine and context are created to embody the semantics of the \SCXML language.
...
The basis is independent of the particular \SCML model which is added in subsequent refinements.
	\item 
