...
A parallel state-chart region, with sub-states |BATTERYOK| and |BATTERYLOW|, is added to the state |OPERATIONAL|\SonAdd{ (Figure~\mbox{\ref{fig:drone4}})}.
...
\SonComment{Figure 4, decreaseCharge decreases the charge by 10 (should it be 1?), the guard also state that charge is greater than or equal to 10 (should it be 21?)}%
