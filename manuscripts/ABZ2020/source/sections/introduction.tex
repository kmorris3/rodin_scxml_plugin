...
This work exposes a shallow embedding of open \SCs~\cite{MoSn16,MoSnHo18}\todo{Rob is this the refence you had in mind} semantics in \EventB.
\SCs provide a graphical language, generalized from state machines, that is popular with engineers, variants of which appear in Matlab Simulink/Stateflow~\cite{MATLAB:2019}\todo{Rob is this the refence you had in mind} and the Ansys tools.  
