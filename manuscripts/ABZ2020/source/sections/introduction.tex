...
This work exposes a shallow embedding of open \SCs~\cite{MoSn16,MoSnHo18}\todo{Rob is this the reference you had in mind} semantics in \EventB.
\SCs provide a graphical language, generalized from state machines, that is popular with engineers, variants of which appear in Matlab Simulink/Stateflow~\cite{MATLAB:2019}\todo{Rob is this the reference you had in mind} and the Ansys tools.  
...
semantics~\cite{MoSn16,MoSnHo18}.  
...
\todo{Karla, Colin: have a look that this sentence, I believe this is supportable, but it might raise hackles }
\todo{Colin said: It looks good to Son and I - anyway this audience will not object! }\todo{Karla said: I like the statementand it is accurate.}
