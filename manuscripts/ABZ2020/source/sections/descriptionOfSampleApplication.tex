...
This is the same as Rule 4 \emph{and-state rule} defined by Syriani et al.
...
to a battery charge of at least 20\% capacity. This can be expressed as |(BATTERYOK = TRUE) => charge > 20|\%
